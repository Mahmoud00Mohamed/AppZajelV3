                      ...
                      {[
                        {
                          ...
                          count: allProducts.filter((p) => p.isBestSeller)
                            .length,
                        },
                        {
                          id: "special",
                          nameKey: isRtl ? "هدية مميزة" : "Special Gift",
                          count: allProducts.filter((p) => p.isSpecialGift)
                            .length,
                        },
                        {
                          id: "premium",
                          nameKey: isRtl ? "فاخر" : "Premium",
                          count: allProducts.filter((p) => p.price > 300)
                            .length,
                        },
                        {
                          id: "affordable",
                          nameKey: isRtl ? "بأسعار معقولة" : "Affordable",
                          count: allProducts.filter((p) => p.price <= 200)
                            .length,
                        },
                      ].map((feature) => (
                        <label
              ...
              {filteredProducts.length > 0 ? (
                viewMode === "grid" ? (
                  ...
                  >
                    {filteredProducts.map((product, index) => (
                      <Link
                        ...
                        key={product.id}
                        className="block bg-white rounded-xl shadow-md border border-neutral-100 overflow-hidden relative group transition-transform duration-300"
                      >
                  ...
                  <motion.div
                    ...
                    className="space-y-4"
                  >
                    // استبدل هذا الجزء في الكود الخاص بك
                    {filteredProducts.map((product, index) => (
                      <div
                        key={product.id}
                        className="block bg-white rounded-xl shadow-md border border-neutral-100 overflow-hidden relative transition-transform duration-300"
                      >
        ...
        {showMobileFilters && (
          ...
          >
            ...
            >
              ...
              <div className="mt-8 mb-16 pt-5 border-t border-neutral-200 space-y-3">
