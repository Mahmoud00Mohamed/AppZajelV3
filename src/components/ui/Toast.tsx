...
const Toast: React.FC<ToastProps> = ({
  ...
  const toastStyles: {
    ...
    success: {
      ...
      progressGradient: "linear-gradient(to right, #22c55e, #4ade80)",
    },
    error: {
    ...
    "cart-success": {
      ...
      gradient: "linear-gradient(to right, #faf5ff, #f3e8ff)",
      iconBg: "bg-primary-100 text-primary-600",
      progressGradient: "linear-gradient(to right, #9333ea, #a855f7)",
    },
    "favorite-success": {
